...
import BuisnessLogin from './Component/User/BuisnessLogin'
import BuisnessSignUp from './Component/User/buisnessSignUp'
          ...
          <main>
            <section className="features">
              <Routes>
                ...
                <Route path="/buisnesslogin" element={<BuisnessLogin />} />
                <Route path="/buisnesssignup" element={<BuisnessSignUp/>} />
                </Routes>
            </section>
          </main> 
        </div>
