...
module.exports = {
  ...
  reservationCancel: require("../Controllers/UserCustomer/ReservationCheck")
    .cancel,
  ...
  reservationCheckBusiness:
    require("../Controllers/UserBusiness/ReservationListCheck").get,
  reservationApprovalBusiness:
    require("../Controllers/UserBusiness/ReservationListCheck").approval,
  reservationDisapprovalBusiness:
    require("../Controllers/UserBusiness/ReservationListCheck").disapproval,
